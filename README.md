...
Simbody is now installed to `/usr/local/Cellar/simbody/<version>/`, where `<version>` is either the version number (e.g., `3.5.2`), or `HEAD` if you specified `--HEAD` above.
